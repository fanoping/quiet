...
struct qt_meta_stringdata_ThumbnailView_t {
    QByteArrayData data[1];
    char stringdata[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ThumbnailView_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ThumbnailView_t qt_meta_stringdata_ThumbnailView = {
    {
QT_MOC_LITERAL(0, 0, 13) // "ThumbnailView"
...
const QMetaObject ThumbnailView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_ThumbnailView.data,
      qt_meta_data_ThumbnailView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ThumbnailView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ThumbnailView.stringdata))
